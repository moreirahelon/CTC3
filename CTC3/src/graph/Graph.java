...
public class Graph { 
    ...
    public void printMatriz(Integer matriz[][], int n)throws Exception{ 
        ...
        if(matriz[0] == null)  
            ...
            FileWriter arq = new FileWriter("c:\\ctc\\grafo.txt");
           ...
           for (int i=0; i < tamanho; i++) {
            	for(int j = 0 ; j < tamanho ; j++) 
            		gravarArq.printf("%2d", matriz[i][j]);
            	gravarArq.printf("%n");
            }
    ...
    public static void main (String args[]){         
        try{ 
            ...
            teste.printMatriz(teste.getMatrizDePesos(), n); 
